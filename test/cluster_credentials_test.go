...
func runServers2(t *testing.T) (srvA, srvB *server.Server, optsA, optsB *server.Options) {
	optsA, _ = server.ProcessConfigFile("./configs/srv_credentials_a.conf")
	optsB, _ = server.ProcessConfigFile("./configs/srv_credentials_b.conf")
...
func TestDoubleRouteConfig2(t *testing.T) {
	srvA, srvB, _, _ := runServers2(t)
	defer srvA.Shutdown()
	defer srvB.Shutdown()
...
func TestBasicClusterPubSub2(t *testing.T) {
	srvA, srvB, optsA, optsB := runServers2(t)
	defer srvA.Shutdown()
	defer srvB.Shutdown()
...
func TestClusterQueueSubs2(t *testing.T) {
	srvA, srvB, optsA, optsB := runServers2(t)
	defer srvA.Shutdown()
	defer srvB.Shutdown()
...
// Issue #22
func TestClusterDoubleMsgs2(t *testing.T) {
	srvA, srvB, optsA, optsB := runServers2(t)
	defer srvA.Shutdown()
	defer srvB.Shutdown()
...
func TestClusterDropsRemoteSids2(t *testing.T) {
	srvA, srvB, optsA, _ := runServers2(t)
	defer srvA.Shutdown()
	defer srvB.Shutdown()
...
// This will test that we drop remote sids correctly.
func TestAutoUnsubscribePropogation2(t *testing.T) {
	srvA, srvB, optsA, _ := runServers2(t)
	defer srvA.Shutdown()
	defer srvB.Shutdown()
