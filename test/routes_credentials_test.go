...
func runRouteServer2(t *testing.T) (*server.Server, *server.Options) {
	opts, err := server.ProcessConfigFile("./configs/cluster_credentials.conf")
...
func TestRouterListeningSocket2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestRouteGoServerShutdown2(t *testing.T) {
	base := runtime.NumGoroutine()
	s, _ := runRouteServer2(t)
	s.Shutdown()
...
func TestSendRouteInfoOnConnect2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestSendRouteSubAndUnsub2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestSendRouteSolicit2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestRouteForwardsMsgFromClients2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestRouteForwardsMsgToClients2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestRouteOneHopSemantics2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestRouteOnlySendOnce2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestRouteQueueSemantics2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestSolicitRouteReconnect2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestMultipleRoutesSameId2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestRouteResendsLocalSubsOnReconnect2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
...
func TestAutoUnsubPropogation2(t *testing.T) {
	s, opts := runRouteServer2(t)
	defer s.Shutdown()
